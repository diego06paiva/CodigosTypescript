const filmesCategoria:string [] = ["Terror", "Comédia", "Aventura", "Drama"] 
...
const filmesCategoria1: (string | number) [] = ["Terror", "Comédia", "Aventura", "Drama", 10]
...
const filmeAno: Array<number | string> = ["vingadores", 2012]
